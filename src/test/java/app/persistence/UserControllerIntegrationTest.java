...
public class UserControllerIntegrationTest {
    ...
    private static final String DB = "carport2";
    ...
    @Test
    public void testCreateUser_Success() throws DatabaseException {
    ...
    @Test
    public void testCreateUser_PasswordMismatch() throws DatabaseException {
        when(ctx.formParam("password1")).thenReturn("password123");
