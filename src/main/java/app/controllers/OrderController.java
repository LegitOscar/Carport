...
public class OrderController {
    ...
    public static void addRoutes(Javalin app, ConnectionPool connectionPool) {
        ...
        app.get("/addfitting", ctx -> {
            ...
            int workerId = ctx.sessionAttribute("workerId");
    ...
    private static void updateOrder(Context ctx, ConnectionPool connectionPool) {
        try {
            ...
            if (order != null) {
                ...
                System.out.println("SENDER EMAIL: Fra '" + oldstatus + "' til '" + orderStatus + "'");

                if("Pending".equalsIgnoreCase(oldstatus) && "in progress".equalsIgnoreCase(orderStatus)){
                    System.out.println("SENDER EMAIL: Order confirmed");
                    sendOrderStatusUpdateEmail(order);
                }
                if("payment".equalsIgnoreCase(oldstatus) && "Completed".equalsIgnoreCase(orderStatus)){
                    System.out.println("SENDER EMAIL: Bill of materials");
